    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className='sidebar' style={{ /*transform: "translateX(-100%)", display: 'flex', */ display: 'flex',flex:'1 1 auto', transform: "translateX(0%)",transition: "0.4s", top:'0', bottom: '0',zIndex:1 ,position: "absolute", height: "100dvh"}}>
            {" "}
            <div
              className='search'
              style={{
